        ...
        <>
            <div className="card-item blog-card border-bottom-0 text-left">
                ...
                <div className="card-content pl-0 pr-0 pb-0">
                    <ul className="post-author d-flex align-items-center justify-content-between mb-3">
                        ...
                        <li>
                            <Link to="#" className="blog__btn">
                                {sectiondata.blogDetails.likes} الإعجابات
                            </Link>
                        </li>
                    </ul>
                    ...
                    <BlogBlockquote bgImg={sectiondata.blogDetails.bgimg} quoteIcon={sectiondata.blogDetails.quoteIcon} desc={sectiondata.blogDetails.desc} name={sectiondata.blogDetails.name} designation={sectiondata.blogDetails.designation} />
