            ...
            <div className="billing-form-item text-left">
                ...
                <div className="billing-content">
                    <div className="our-office-content">
                        <img src={contactinfo.img} alt="group-img" className="w-100 radius-round" />
                ...
                <div className="billing-content">
                    <ul className="list-items">
                        ...
                        <li className="d-flex align-items-center justify-content-between color-text-2">
                            <strong className="font-weight-medium">{contactinfo.closeday}</strong><strong className="color-text">مغلق</strong>
                        </li>
                    </ul>
                </div>
            </div>
