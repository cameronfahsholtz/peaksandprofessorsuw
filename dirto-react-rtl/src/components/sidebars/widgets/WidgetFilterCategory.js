        ...
        <>
            <div className="sidebar-widget text-left">
                ...
                <div
                     ...
                     className="showmore-btn font-weight-semi-bold text-capitalize d-block mr-auto mr-auto text-center radius-rounded p-0">
                    {
                        isOpenCat ?
                        <span className="lessmore-txt">عرض أقل</span>
                        :
